                ...
                <div class="flex flex-col h-full">
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                        ...
                        <div class="pt-4 mt-4 border-t border-neutral-200">
                            <a href="{{ route('subscriptions.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('subscriptions.*') ? 'bg-primary-accent text-white' : 'text-neutral-700 hover:bg-neutral-100' }}">
                                <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="{{ route('admin.orders.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('admin.orders.*') ? 'bg-primary-accent text-white' : 'text-neutral-700 hover:bg-neutral-100' }}">
                                <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
