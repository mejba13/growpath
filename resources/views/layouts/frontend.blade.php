...
<body class="font-sans antialiased bg-white">
    ...
    <!-- Footer -->
    <footer class="relative bg-gradient-to-br from-primary-brand via-neutral-900 to-primary-brand text-white overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-16 lg:py-20">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-10 gap-12 lg:gap-8">
                    <!-- Company Info - Wider Column -->
                    <div class="lg:col-span-4">
                        <!-- Logo -->
                        <div class="flex items-center mb-6">
                            <div class="w-12 h-12 bg-gradient-to-br from-primary-accent to-secondary-accent rounded-xl flex items-center justify-center mr-3">
                        ...
                        <div class="flex items-center gap-3">
                            <a href="#" class="group w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110" aria-label="Twitter">
                                <svg class="w-5 h-5 text-neutral-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"/>
                                </svg>
                            </a>
                            <a href="#" class="group w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110" aria-label="LinkedIn">
                                <svg class="w-5 h-5 text-neutral-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                                </svg>
                            </a>
                            <a href="#" class="group w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110" aria-label="Facebook">
                                <svg class="w-5 h-5 text-neutral-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <a href="#" class="group w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110" aria-label="GitHub">
                                <svg class="w-5 h-5 text-neutral-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="lg:col-span-2">
                        <h4 class="text-lg font-bold mb-6 text-white">Product</h4>
                        <ul class="space-y-3">
                            <li>
                                <a href="{{ route('features') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span>Features</span>
                                </a>
                            ...
                            <li>
                                <a href="{{ route('pricing') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span>Pricing</span>
                            ...
                            <li>
                                <a href="{{ route('api') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span>API</span>
                            ...
                            <li>
                                <a href="{{ route('integrations') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <ul class="space-y-3">
                            <li>
                                <a href="{{ route('about') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span>About Us</span>
                            ...
                            <li>
                                <a href="{{ route('careers') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span>Careers</span>
                            ...
                            <li>
                                <a href="{{ route('blog') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span>Blog</span>
                            ...
                            <li>
                                <a href="{{ route('contact') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span>Contact</span>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <ul class="space-y-3">
                            <li>
                                <a href="{{ route('help-center') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                            ...
                            <li>
                                <a href="{{ route('documentation') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                            ...
                            <li>
                                <a href="{{ route('privacy-policy') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                            ...
                            <li>
                                <a href="{{ route('terms') }}" class="group inline-flex items-center text-neutral-300 hover:text-white transition-all duration-300">
                                    <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
            ...
            <div class="border-t border-white/10 py-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center gap-6 text-sm">
                        ...
                        <a href="{{ route('terms') }}" class="text-neutral-400 hover:text-white transition-colors">Terms</a>
                        <a href="#" class="text-neutral-400 hover:text-white transition-colors">Sitemap</a>
                    </div>
                </div>
            </div>
        </div>
